...
{
    /// <inheritdoc />
    public partial class UpdateMediaAccount_AddPost : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CommentSenderId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comment_MediaAccounts_CommentSenderId",
                        column: x => x.CommentSenderId,
                        principalTable: "MediaAccounts",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comment_CommentSenderId",
                table: "Comment",
